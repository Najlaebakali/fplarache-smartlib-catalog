...
@DgsComponent
public class FilterByGenreAndAuthorDatafetcher {
  @DgsData(
      parentType = "Query",
      field = "filterByGenreAndAuthor"
  )
  public List<Livre> getFilterByGenreAndAuthor(DataFetchingEnvironment dataFetchingEnvironment) {
    return null;
  }
}
