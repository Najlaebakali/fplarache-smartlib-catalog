...
@DgsComponent
public class GetLivresByStatusDatafetcher {
  @DgsData(
      parentType = "Query",
      field = "getLivresByStatus"
  )
  public List<Livre> getGetLivresByStatus(DataFetchingEnvironment dataFetchingEnvironment) {
    return null;
  }
}
