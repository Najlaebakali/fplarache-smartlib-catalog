...
describe('aliasedQuery', function () {
    it('should produce a valid openapi spec', function () {
        var schema = (0, fs_1.readFileSync)(path.join(__dirname, 'schema.graphql')).toString();
        var inputQueryFilename = path.join(__dirname, 'aliasedQuery.graphql');
        var query = (0, fs_1.readFileSync)(inputQueryFilename).toString();
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        var expectedOutput = require('./aliasedQuery.json');
